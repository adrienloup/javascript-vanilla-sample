(function() {
	...
	function gotoBag(product) {
		for (let i = 0; i < products.length; i++) {
			if( products[i].id == product.id) {
				...
				if (!products[i].bag) {
					products[i].bag = true
					let html = '<div id="' + products[i].id + '" class="product' + (products[i].discount ? ' soldes' : '') + '"><div class="img"><img src="img/' + products[i].img + '.jpeg" alt="' + products[i].title + '"></div><div class="caption"><span class="title">' + products[i].title + '</span><span class="price">' + (products[i].discount ? products[i].discount.toFixed(2) : products[i].price) + ' €</span></div></div>'
	...
	function gotoDetails(product) {
		for (let i = 0; i < products.length; i++) {
			if (products[i].id == product.id) {
				let _product = '<div id="' + products[i].id + '" class="product' + (products[i].discount ? ' soldes' : '') + '"><div class="img"><img src="img/' + products[i].img + '.jpeg" alt="' + products[i].title + '"></div><div class="caption"><span class="brand">' + products[i].brand + '</span> - <span class="title">' + products[i].title + '</span><span class="collection">Collection ' + products[i].collection + '</span><span class="color">Couleurs : ' + products[i].color.join(', ') + '</span><span class="size">Tailles : ' + products[i].size.join(', ') + '</span><span class="price">' + products[i].price + ' €' + (products[i].discount ? '<span>' + products[i].discount.toFixed(2) + ' €</span>' : '') + '</span><span class="bag' + (products[i].bag ? ' disable' : '') + '">' + (products[i].bag ? 'Retirer du panier' : 'Ajouter au panier') + '</span></div>'
